...
for j=1:nvar
    Yvec = Y(:,j);
    OLSout = OLSmodel(Yvec,X,0); %% Pæling Leifi - Athuga hvort const eigi ekki að koma úr input-inu ? - Nei búið að gera sömu aðgerð í VARmakexy svo óþarfi að bæta þessum dálkum aftur við
    aux = ['eq' num2str(j)];
